...
public class CartControllerTest {
    ...
    public void verify_addToCart() {
        ...
        BigDecimal expectedTotal = itemPrice.multiply(BigDecimal.valueOf(request.getQuantity()))
    ...
    public void verify_removeFromCart() {
        ...
        BigDecimal expectedTotal = generatedCart.getTotal()
                .subtract(itemPrice.multiply(BigDecimal.valueOf(request.getQuantity())));
